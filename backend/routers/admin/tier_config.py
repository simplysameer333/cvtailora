"""Admin tier-config endpoint (superadmin only).

Split out of routers/config.py so admin functionality is grouped separately
from the public config reads. Route path unchanged: PUT /api/admin/config/tiers.
"""
