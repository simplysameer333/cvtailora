...
import { FiUploadCloud, FiFile, FiZap, FiTarget, FiAward, FiX, FiBriefcase, FiLoader } from "react-icons/fi";
import { uploadResume, listSavedResumes, createSessionFromLibraryResume, type SavedResume } from "@/lib/api";
...
export default function UploadPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      {/* Benefits — only on fresh upload (no library, not tailoring) */}
